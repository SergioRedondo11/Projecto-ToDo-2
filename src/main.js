...
function createToDoHTML (toDo) {
    ...
    <button aria-label="Delete button" type="button" class="ml-auto text-gray-600 cursor-pointer hover:scale-110 hover:rotate-90 transition-transform delete-button">
    ...
    const deleteTodo = article.querySelector('.delete-button')

    //* Le escuchas el click
    deleteTodo.addEventListener('click', () => {
      const toDoId = article.id;
    
      const indexToRemove = allToDos.findIndex(todo => todo.id === toDoId);
